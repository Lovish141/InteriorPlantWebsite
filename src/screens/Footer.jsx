...
const Footer = () => {
  ...
  <div className="bg-[linear-gradient(133deg,_#566270_0%,_#283444_100%)]">
    <div className="max-w-[1490px] mx-auto px-10 py-[80px]">
        ...
        <div className="w-full xl:w-auto flex flex-col items-center xl:items-start">
          ...
          <div className="relative w-full xs:w-[380px] xl:w-[320px] mt-11">
            <input
             ...
             placeholder="Email"/>
             <div className="bg-[linear-gradient(90deg,_#2AF598_0%,_#009EFD_100%)] absolute top-2/4 -translate-y-2/4 right-3 px-6 py-2.5 rounded-full cursor-pointer text-white">Subscribe</div>
          </div>
      ...
      <h6 className="text-white text-center text-base lg:text-lg">&copy; Daunku - All rights reserved</h6>
    </div>
  </div>
  )
};
