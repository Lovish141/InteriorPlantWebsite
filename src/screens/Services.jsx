      ...
      return(
        <FadeIn key={index} delay={0.2} direction="down">
          <div className="flex flex-col lg:flex-row gap-4 w-full items-center">
            <img src={service.icon} alt="" className="max-h-[84px] max-w-[84px] "/>
            <div className="flex flex-col gap-1.5">
              <h3 className="text-center lg:text-left text-2xl lg:text-[24px] text-fontBlack font-medium">{service.title}</h3>
