...
const Products = () => {
  return <div className="flex flex-col 2xl:flex-row gap-[128px] 2xl:gap-2 2xl:justify-between mt-[160px] 2xl:mt-[270px] mb-[160px] max-w-[1490px] mx-auto px-10 w-full ">
    <FadeIn delay={0.2} direction="right">
      <div className="flex flex-col">
        <h1 className="text-center 2xl:text-start text-fontBlack text-5xl font-medium mb-g lg:text-[64px]">
          {productsTitle}
        </h1>
        <button
    ...
    <div className="w-full flex flex-col md:flex-row gap-[160px] md:gap-6 ">
      {products.map((product,index)=>{
        return (
           <FadeIn key={index} delay={(index + 1) * 0.2} direction="left" fullWidth>
