...
const Hero = () => {
  ...
  style={{
    ...
    backgroundSize:'cover',
     ...
     <div className={`block md:hidden w-full fixed ${
     ...
     } left-0 bg-[#dde0e5] h-[410-px] shadow-xl z-10 py-8 px-12 rounded-b-xl transition-all duration-[800ms]`}>
      ...
      <img src={cartIcon} className="mt-8 mx-auto cursor-pointer"/>
     </div>
     </div>
     ...
     <FadeIn delay={0.2} direction="up" padding fullWidth>
      <div className="relative w-full xs:w-[460px] mt-11 ">
        <input type="text" placeholder="Search" className="rounded-full w-full pl-6 pr-[68px] py-4 bg-white outline-none text-fontGray text-base xs:text-lg placeholder-fontGray" />
        <img src={searchIcon} alt="" className="absolute top-2/4 -translate-y-2/4 right-3 h-11 w-11 cursor-pointer"></img>
      </div>
     </FadeIn>
